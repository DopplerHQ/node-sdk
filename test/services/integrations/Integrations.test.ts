...
describe('test Integrations', () => {
  ...
  describe('test get', () => {
    test('test api call', () => {
      const scope = nock('https://api.doppler.com')
        .get('/v3/integrations/integration?integration=voluptatibus')
        .reply(200, { data: {} });
      return sdk.integrations.get('voluptatibus').then((r: any) => expect(r.data).toEqual({}));
    });

    test('test will throw error if required fields missing', () => {
      const scope = nock('https://api.doppler.com')
        .get('/v3/integrations/integration?integration=iusto')
        .reply(200, { data: {} });
  ...
  describe('test update', () => {
    test('test api call', () => {
      const scope = nock('https://api.doppler.com')
        .put('/v3/integrations/integration?integration=perspiciatis')
        .reply(200, { data: {} });
    ...
    test('test will throw error if required fields missing', () => {
      const scope = nock('https://api.doppler.com')
        .put('/v3/integrations/integration?integration=autem')
        .reply(200, { data: {} });
    ...
    test('test will throw error on a non-200 response', () => {
      const scope = nock('https://api.doppler.com')
        .put('/v3/integrations/integration?integration=voluptatum')
        .reply(404, { data: {} });
      return expect(async () => await sdk.integrations.update({}, 'voluptatum')).rejects.toThrow();
    });
  });
  ...
  describe('test delete', () => {
    test('test api call', () => {
      const scope = nock('https://api.doppler.com')
        .delete('/v3/integrations/integration?integration=natus')
        .reply(200, { data: {} });
      return sdk.integrations.delete('natus').then((r: any) => expect(r.data).toEqual({}));
    });
    ...
    test('test will throw error on a non-200 response', () => {
      const scope = nock('https://api.doppler.com')
        .delete('/v3/integrations/integration?integration=sequi')
        .reply(404, { data: {} });
      return expect(async () => await sdk.integrations.delete('sequi')).rejects.toThrow();
    });
  });
});
