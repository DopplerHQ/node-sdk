...
describe('test ActivityLogs', () => {
  ...
  describe('test retrieve', () => {
    test('test api call', () => {
      const scope = nock('https://api.doppler.com')
        ...
        .reply(200, { data: {} });
      return sdk.activityLogs.retrieve('voluptatum').then((r: any) => expect(r.data).toEqual({}));
    });
    ...
    test('test will throw error on a non-200 response', () => {
      const scope = nock('https://api.doppler.com')
        .get('/v3/logs/log?log=quidem')
        .reply(404, { data: {} });
      return expect(async () => await sdk.activityLogs.retrieve('quidem')).rejects.toThrow();
    });
  });
  ...
  describe('test list', () => {
    test('test api call', () => {
      const scope = nock('https://api.doppler.com')
        .get('/v3/logs?page=aut&per_page=5')
        .reply(200, { data: {} });
      return sdk.activityLogs
        .list({ page: 'aut', perPage: 5 })
