...
describe('test Projects', () => {
  ...
  describe('test list', () => {
    test('test api call', () => {
      const scope = nock('https://api.doppler.com')
        .get('/v3/projects?page=3&per_page=8')
        .reply(200, { data: {} });
      return sdk.projects
        .list({ page: 3, perPage: 8 })
  ...
  describe('test get', () => {
    test('test api call', () => {
      const scope = nock('https://api.doppler.com')
        .get('/v3/projects/project?project=repellat')
        .reply(200, { data: {} });
      return sdk.projects.get('repellat').then((r: any) => expect(r.data).toEqual({}));
    });

    test('test will throw error if required fields missing', () => {
      const scope = nock('https://api.doppler.com')
        .get('/v3/projects/project?project=quidem')
        .reply(200, { data: {} });
